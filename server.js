...
const MODEL_CATALOG = [
  ...
  // --- HUGGING FACE TOP TRENDING & MOST DOWNLOADED (2026) ---
  {
    id: 'smollm2:1.7b',
    name: 'Hugging Face SmolLM2 1.7B',
    category: 'lightweight',
    categoryName: 'Ультра-быстрые',
    badge: 'Hugging Face SOTA',
    params: '1.7B',
    size: '1.2 GB',
    ramMin: '2.5 GB RAM',
    quant: 'Q4_K_M',
    description: 'Официальный флагман компактных моделей Hugging Face. Обучена на 11 трлн токенов с феноменальным качеством для мобильных и локальных систем.',
    tags: ['huggingface', 'smollm', 'lightweight', 'speed']
  },
  {
    id: 'smollm2:360m',
    name: 'Hugging Face SmolLM2 360M',
    category: 'lightweight',
    categoryName: 'Ультра-быстрые',
    badge: 'HF Micro',
    params: '360M',
    ...
    ramMin: '1 GB RAM',
    quant: 'Q4_K_M',
    description: 'Ультра-легкая модель от Hugging Face для моментального отклика на любом слабом оборудовании и встраиваемых чипах.',
    tags: ['huggingface', 'smollm', 'lightweight', 'micro']
  },
  {
    id: 'hermes3:8b',
    ...
    category: 'chat',
    categoryName: 'Чат и тексты',
    badge: 'Trending on HF',
    params: '8.2B',
    size: '5.1 GB',
    ramMin: '9 GB RAM',
    quant: 'Q4_K_M',
    description: 'Самый популярный независимый тюнинг на Hugging Face от Nous Research. Нейтральное выравнивание, безупречный Tool Calling и следование промптам.',
    tags: ['huggingface', 'nous', 'hermes', 'agent', 'chat']
  },
  {
    ...
    category: 'reasoning',
    categoryName: 'Рассуждения',
    badge: 'Mistral Frontier',
    params: '24.1B',
    size: '15 GB',
    ramMin: '24 GB RAM',
    quant: 'Q4_K_M',
    description: 'Свежий открытый релиз Mistral AI под лицензией Apache 2.0. Контекст 32k, передовые результаты в математике, коде и рассуждениях.',
    tags: ['huggingface', 'mistral', 'reasoning', 'heavy']
  },
  {
    id: 'ministral-8b:8b',
    ...
    ramMin: '8.5 GB RAM',
    quant: 'Q4_K_M',
    description: 'Нейросеть с чередующимся вниманием (sliding window) для сверхнизкой задержки на локальных машинах.',
    tags: ['huggingface', 'mistral', 'speed', 'lightweight']
  },
  {
    id: 'olmo-2:7b',
    name: 'Ai2 OLMo 2 7B',
    category: 'chat',
    categoryName: 'Чат и тексты',
    badge: '100% Open Science',
    params: '7.1B',
    size: '4.5 GB',
    ramMin: '8 GB RAM',
    quant: 'Q4_K_M',
    description: 'Полностью прозрачная модель от Allen Institute for AI (Ai2) с открытым датасетом Dolma, рецептом обучения и чекпоинтами.',
    tags: ['huggingface', 'allenai', 'olmo', 'science']
  },
  {
    id: 'aya-expanse:8b',
    ...
    ramMin: '9 GB RAM',
    quant: 'Q4_K_M',
    description: 'Лидер открытых мультиязычных бенчмарков от Cohere For AI. Поддерживает 23+ языка с высокой культурной и грамматической точностью.',
    tags: ['huggingface', 'cohere', 'aya', 'multilingual']
  },
  {
    id: 'moonlight:16b',
    name: 'Moonshot AI Moonlight 16B MoE',
    category: 'coding',
    categoryName: 'Программирование',
    badge: 'Kimi MoE',
    params: '16B MoE (2.2B active)',
    size: '8.8 GB',
    ramMin: '12 GB RAM',
    quant: 'Q4_K_M',
    description: 'Открытая MoE модель от создателей Kimi (Moonshot AI). Огромная эрудиция при сверхнизкой нагрузке на процессор.',
    tags: ['huggingface', 'moonshot', 'kimi', 'moe', 'coding']
  },
  {
    id: 'liquid-lfm:3b',
    name: 'Liquid LFM 3B',
    category: 'lightweight',
    categoryName: 'Ультра-быстрые',
    badge: 'Non-Transformer',
    params: '3.1B',
    size: '2.0 GB',
    ramMin: '3.5 GB RAM',
    quant: 'Q4_K_M',
    description: 'Революционная архитектура Liquid Foundation Model (LFM) без стандартных трансформеров: постоянная память при любом размере контекста.',
    tags: ['huggingface', 'liquid', 'lightweight', 'speed']
  },
  {
    id: 'exaone-3.5:7.8b',
    ...
    ramMin: '8.5 GB RAM',
    quant: 'Q4_K_M',
    description: 'Флагманская открытая модель исследовательского института LG. Превосходные результаты в кодировании, математике и извлечении фактов.',
    tags: ['huggingface', 'lg', 'exaone', 'enterprise']
  },
  {
    id: 'all-minilm-l6-v2',
